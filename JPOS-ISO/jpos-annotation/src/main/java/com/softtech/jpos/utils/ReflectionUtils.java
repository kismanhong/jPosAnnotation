...
//	    return result;
	 ...
	 */
	public static Field findField(Class<?> clazz, String name, Class<?> type) throws JPosAnnotationException{
...
//		return null;
		throw new JPosAnnotationException("cannot find field :"+name+" from class :"+clazz.getCanonicalName());
	}
	 ...
	 * @throws JPosAnnotationException
	 */
	public static Field findField(Class<?> clazz, String name) throws JPosAnnotationException{
	 ...
	 */
	public static Method findMethod(Class<?> clazz, String name) throws JPosAnnotationException {
	 ...
	 * @return the Method object, or <code>null</code> if none found
	 */
	public static Method findMethod(Class<?> clazz, String name, Class<?>[] paramTypes) throws JPosAnnotationException {
//		Assert.notNull(clazz, "Class must not be null");
//		Assert.notNull(name, "Method name must not be null");
		...
		throw new JPosAnnotationException("cannot find method :"+name+" from class :"+clazz.getCanonicalName());
	}
