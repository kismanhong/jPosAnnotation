...
/**
 * @author Kisman Hong
 * for reversal response purpose, field that is tagged by this class will be included for set {@link ISOMsg} to field
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.FIELD)
public abstract @interface ReversalResponse {
